...
extern "C" {
void ConvertHexDigitToBinary(char hexDigit, char* binaryOutput);
int ConvertHexDigitToDecimal(char hexDigit);
}
...
private slots:
    ...
    void on_valor_bases_num_textChanged(const QString &arg1);
